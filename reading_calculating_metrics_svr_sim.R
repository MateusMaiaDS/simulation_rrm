...
for(i in 1:30){
  ...
  total_time_svr =+ sum(map_dbl(mod_result[[i]]$svr_lin, ~.x$time))
  total_time_svr =+ sum(map_dbl(mod_result[[i]]$svr_pol, ~.x$time))
  total_time_svr =+ sum(map_dbl(mod_result[[i]]$svr_rbf, ~.x$time))
  total_time_svr =+ sum(map_dbl(mod_result[[i]]$svr_lap, ~.x$time))
